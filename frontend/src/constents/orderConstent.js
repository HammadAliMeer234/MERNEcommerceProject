export const CREATE_ORDER_REQUEST = "ALL_ORDERS_REQUEST";
export const CREATE_ORDER_SUCCESS = "ALL_ORDERS_SUCCESS";
export const CREATE_ORDER_FAIL = "ALL_ORDERS_FAIL";
...
export const DELETE_ORDER_FAIL = "DELETE_ORDER_RESET"
